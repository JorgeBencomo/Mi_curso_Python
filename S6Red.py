...
def adicionar_amigos(amigos):
    linea = input("Adiciona el nombre de tu amigo o los nombres de tus amigos, separados por una ',': ")
    amigos += linea.split(",")
   # return amigos
...
def opcion_menu():
    ...
    print("  5. Adicionar amigos")
    print("  6. Estado de amigos")
    print("  0. Salir")
